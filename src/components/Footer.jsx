...
const Footer = () => {
    return (
        <div>
            <footer className="footer text-center items-center bg-gray-700 text-gray-100 p-10">
  <nav>
    <h6 className="footer-title">Services</h6>
    <a className="link link-hover">Career Counseling</a>
    <a className="link link-hover">Resume Building</a>
    <a className="link link-hover">Job Search Assistance</a>
  ...
  <nav>
    ...
    <a className="link link-hover">Personality Development</a>
    <a className="link link-hover">Career Coaching & Mentoring</a>
    <a className="link link-hover">Restart Career</a>
  </nav>
</footer>
<footer className="footer bg-gray-700 text-gray-100 border-base-300 border-t px-10 py-4">
